// This file defines the 'GameOver' scene for the Phaser game, which is displayed when the player loses or dies.
// It shows the player's final time, a "GAME OVER" message, and allows the player to restart the game by pressing SPACE or clicking.

import Method from "../keys&methods/methods.js"

export default class GameOver extends Phaser.Scene {

    // Constructor for the GameOver scene. It assigns a key to the scene for easy access.
    constructor() {
        super({key: "gameover"});
    };

    // The create method is executed when the scene is initialized. It sets up the visual elements of the game over screen.
    create() {
        this.cameras.main.setBackgroundColor(0xcc0000); // Set the background color to a red shade indicating failure
        this.sound.play("dead");                        // Play the death sound effect when the player loses
        ...
        // Create and position text labels for the final time, game over message, and restart instructions using the newText method
